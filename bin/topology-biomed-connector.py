...
SITESPI = '/vapor/downloadLavoisier/option/xml/view/vapor_sites/param/vo=biomed'
SERVENDPI = '/vapor/downloadLavoisier/option/xml/view/vapor_endpoints'
    ...
    def _get_sites_internal(self, siteList, scope, doc):
        try:
            ...
            for site in sites:
                ...
                siteList[siteName]['ngi'] = site.getAttribute('ROC')
